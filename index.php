        ...
        <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
            <div class="row">
                <div class="col-12 col-md px-0 text-center text-md-left ">
                    ...
                    <p class="lead mb-0"><a target="_self" href="books/singleBook.php" class="text-white font-weight-bold">Continue reading...</a></p>
                </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col-12 col-md-8">
                            <div class="card-body">
                                ...
                                <h3 class="mb-0"><a target="_self" class="text-dark" href="#">Latest Book Title</a></h3>
                                <div class="mb-1 text-muted">Nov 12</div>
                                <p class="card-text mb-auto">Harry Potter and the Philosopher's Stone.</p>
                                <a target="_self" href="books/singleBook.php">Continue reading</a>
                            </div>
                        </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col-12 col-md-8">
                            <div class="card-body">
                                ...
                                <h3 class="mb-0"><a target="_self" class="text-dark" href="#">Latest Movie Title</a></h3>
                                <div class="mb-1 text-muted">Nov 11</div>
                                <p class="card-text mb-auto">Iron Man</p>
                                <a target="_self" href="#">Continue reading</a>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
